...
- 生成时间：`2026-06-13T16:31:13.511435+00:00`
...
课程 95+ 目标已具备主要工程与评测证据；比赛级仍需扩展真实端到端评测和 TTS 延迟优化。
...
| 领域知识库与 RAG | `implemented` | `data/knowledge/ship_safety_corpus.jsonl`<br>`data/knowledge/ship_safety_index.json` | 当前知识条目 20 条。 |
...
|---|---|---:|
| `README.md` | 存在 | 6548 |
| `docs/PHASE1_SCORECARD.md` | 存在 | 7736 |
